...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    ps = exp_scores / np.sum(exp_scores, axis=1)[:, np.newaxis]
  ...
  def predict(self, X):
    ...
    ###########################################################################
    t2 = X.dot(self.params['W1']) + self.params['b1']
    t1 = t2.clip(0)
    scores = t1.dot(self.params['W2']) + self.params['b2']
